            ...
            <div className="relative flex justify-center -mt-16 mb-6">
              <div className="p-1.5 bg-white rounded-full shadow-lg">
                <img
                  ...
                  alt={user.name}
                  className="w-36 h-36 rounded-full object-cover border-4 border-orange-50"
                />
              </div>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 max-w-xl mx-auto">
                <div className="bg-gray-50 p-6 rounded-3xl text-left border border-gray-100">
                  <p className="text-[10px] text-gray-400 font-black uppercase mb-1">Full Name</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
                ...
                <button 
                  onClick={async () => {
                    ...
                    router.push("/login");
                    toast.success("Logged out from database");
                  }}
